...
function Stock() {
  ...
  useEffect(() => {
    fetch(
      "https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=GOOGL&outputsize=compact&apikey=${process.env.REACT_APP_API_KEY}"
    )
